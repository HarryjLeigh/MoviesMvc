...
public class MoviesController : Controller
{
    ...
    {
        if (_context.Movie == null) return Problem("Entity set 'Mvc MovieContext.Movie' is null.");
        ...
        if (!string.IsNullOrEmpty(movieGenre)) movies = movies.Where(s => s.Genre == movieGenre);
